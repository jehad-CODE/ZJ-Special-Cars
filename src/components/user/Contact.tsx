  ...
  return (
    ...
    >
      <Box sx={{
        ...
        scrollbarWidth: 'none',
        pb: 4 // Added padding bottom for more scroll space
      }}>
        <Typography 
        ...
        <Grid container spacing={3} justifyContent="center" sx={{ maxWidth: 1000, width: '100%' }}>
        ...
        {/* Spacer box to create more scroll space */}
        <Box sx={{ 
