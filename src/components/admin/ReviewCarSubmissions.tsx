                ...
                <Grid item xs={12} sm={6} md={4} key={car._id}>
                  <Card sx={{ 
                    ...
                    <Box sx={{ p: 2, display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: 1 }}>
                      <Button size="small" variant="outlined" startIcon={<PhotoLibraryIcon />}
      ...
      <Dialog open={openSortDialog} onClose={() => setOpenSortDialog(false)}
        ...
        <DialogContent>
          <RadioGroup value={sortBy} onChange={(e) => setSortBy(e.target.value)}>
            ...
            <FormControlLabel value="yearNewest" control={<Radio />} label="Year: Newest First" />
            <FormControlLabel value="yearOldest" control={<Radio />} label="Year: Oldest First" />
          </RadioGroup>
        </DialogContent>
        <DialogActions>
        ...
        <DialogContent dividers>
          <form onSubmit={handleSubmit}>
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} sm={6}>
                <TextField label="Car Mileage (km)" value={carMileage} onChange={(e) => setCarMileage(e.target.value)}
                  fullWidth required InputProps={{ style: { color: 'white' } }}
                  InputLabelProps={{ style: { color: '#aaa' } }} />
              </Grid>
              <Grid item xs={12}>
